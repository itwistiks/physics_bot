...
Revision ID: 02dc0f20e0f7
Revises: 
Create Date: 2025-07-26 12:32:55.700733
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('NO_SUB', 'SUB', 'TEACHER', name='userstatus'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['topic_id'], ['topics.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('user_id', 'topic_id', 'subtopic_id')
    )
