...
def upgrade() -> None:
    ...
    op.create_table('reminders',
                    ...
                    sa.Column('reminder_type', sa.Enum('INACTIVE', 'HOLIDAY',
                                                       'PROMO', name='remindertype'), nullable=True),
    ...
    op.create_table('users',
                    ...
                    sa.Column('status', sa.Enum('NO_SUB', 'SUB', 'PRO_SUB', 'TEACHER',
                                                'MODERATOR', 'ADMIN', name='userstatus'), nullable=True),
                    sa.Column('phone', sa.String(length=20), nullable=True),
                    sa.Column('city', sa.String(length=50), nullable=True),
                    sa.Column('last_interaction_time',
                              sa.DateTime(), nullable=True),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('theories',
                    ...
                    sa.Column('complexity', sa.Enum('BASIC', 'ADVANCED',
                                                    'HIGH', name='complexity'), nullable=True),
    ...
    op.create_table('tasks',
                    ...
                    sa.Column('topic_id', sa.Integer(), nullable=True),
                    sa.Column('subtopic_id', sa.Integer(), nullable=True),
                    sa.Column('part_number', sa.Enum(
                        'PART_ONE', 'PART_TWO', name='partnumber'), nullable=True),
                    sa.Column('complexity', sa.Enum('BASIC', 'ADVANCED',
                                                    'HIGH', name='complexity'), nullable=True),
                    ...
                    sa.Column('video_analysis_url', sa.String(
